...
public class RomanNumeralsTests
{
    ...
    [Fact]
    public void To_roman_returns_empty_string_for_zero()
    {
        Assert.Equal("", 0.ToRoman());
    }

    [Fact]
    public void To_roman_returns_empty_string_for_negative_value()
    {
        Assert.Equal("", (-1).ToRoman());
    }

    [Fact]
    public void To_roman_returns_empty_string_for_value_greater_than_3999()
    {
        Assert.Equal("", 4000.ToRoman());
    }
}